...
import com.visen.homemoudle.databinding.FragmentWzbookBinding
...
class WZBookFragment : MyBaseFragment<TouTiaoViewModel, FragmentWzbookBinding>() {
    ...
    override fun layoutId() = R.layout.fragment_wenzhang
    ...
    companion object {
        fun newInstance(type: Int): WZBookFragment {
            val args = Bundle()
            args.putInt(ApiService.TYPES, type)
            val fragment = WZBookFragment()
