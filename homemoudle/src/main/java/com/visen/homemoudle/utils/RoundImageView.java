...
public class RoundImageView extends AppCompatImageView {
    ...
    public static final int DEFAUT_ROUND_RADIUS = 5;//默认圆角大小
    ...
    private int mType = 1;// 记录是圆形还是圆角矩形
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mRoundRadius = (int) dp2px(context, DEFAUT_ROUND_RADIUS);
        initView();
    }
